  ...
  try {
    ...
    const { data: newRoom, error: roomError } = await supabase
      ...
      .insert([{
        ...
        is_active: true,
        name: newName,
        timer_config: original.timer_config,
        notebook_enabled: original.notebook_enabled,
        notebook_visible_level: original.notebook_visible_level,
        notebook_visible_placement: original.notebook_visible_placement,
        notebook_visible_tempo: original.notebook_visible_tempo,
        notebook_visible_respiration: original.notebook_visible_respiration,
        notebook_visible_feeling: original.notebook_visible_feeling,
        notebook_visible_series: original.notebook_visible_series,
        notebook_series_count: original.notebook_series_count,
        notebook_visible_charges: original.notebook_visible_charges,
        notebook_visible_reps: original.notebook_visible_reps
      }])
      .select()
      .single()
